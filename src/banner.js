...
export default function Banner(){
    return(
        <div className='flex relative w-full lg:h-[600px] h-auto overflow-hidden'>
            ...
            <img src={Gulajawa} className='absolute z-10 -bottom-3 lg:-bottom-5 left-5 lg:left-40 w-1/4'/>
            <img src={Cabai} className='absolute z-10 m-auto inset-x-0 -bottom-1 lg:bottom-[5px] w-1/3'/>
            <img src={Kacang} className='absolute z-10 -bottom-2 right-5 lg:right-40 w-1/4'/>
